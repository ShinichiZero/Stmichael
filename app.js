  ...
  en: {
    ...
    chaplet: {
      ...
      lines: [
        ...
        "Salutation of the nine choirs of Angels.",
        "Recite one Our Father and three Hail Marys for each choir.",
        "Conclude with prayers to St. Michael, St. Gabriel, St. Raphael and guardian angels."
      ]
    },
    litany: {
      title: "Litany of St. Michael",
      lines: [
    ...
    panic: "Jesus, Mary, and Joseph, protect me. St. Michael, defend me now."
  },
  la: {
    prayer: {
      ...
      lines: [
        ...
        "Satanam aliosque spiritus malignos in infernum detrude,",
        "qui ad perditionem animarum pervagantur in mundo. Amen."
      ]
    },
    chaplet: {
      title: "Corona Sancti Michaelis",
      lines: [
        "Deus, in adiutorium meum intende.",
        "Domine, ad adiuvandum me festina.",
        "Salutatio novem choris Angelorum.",
        "Pro quolibet choro recita Pater noster et tres Ave Maria.",
        "Conclude precibus ad Sanctos Michaelem, Gabrielem, Raphaelem et Angelos custodes."
      ]
    },
    litany: {
      title: "Litania Sancti Michaelis",
      lines: [
        "Kyrie, eleison.",
        "Christe, eleison.",
        "Sancta Maria, Regina Angelorum, ora pro nobis.",
        "Sancte Michael, divina sapientia plenus, ora pro nobis.",
        "Sancte Michael, perfecte adorator Verbi incarnati, ora pro nobis."
      ]
    },
    panic: "Iesu, Maria, Ioseph, protegite me. Sancte Michael, defende me nunc."
  },
  it: {
    prayer: {
      ...
      lines: [
        ...
        "Sii nostro sostegno contro la malvagità e le insidie del demonio.",
        "Che Dio eserciti il suo dominio su di lui, noi supplichevoli preghiamo;",
        "e tu, Principe della milizia celeste,",
        "con la potenza divina ricaccia nell'inferno Satana",
        "e gli altri spiriti maligni che si aggirano nel mondo per perdere le anime. Amen."
      ]
    },
    chaplet: {
      title: "Corona di San Michele",
      lines: [
        "O Dio, vieni a salvarmi.",
        "Signore, vieni presto in mio aiuto.",
        "Salutazione ai nove cori angelici.",
        "Per ogni coro recita un Padre nostro e tre Ave Maria.",
        "Concludi con preghiere a San Michele, San Gabriele, San Raffaele e agli angeli custodi."
      ]
    },
    litany: {
      title: "Litania di San Michele",
      lines: [
        "Signore, pietà.",
        "Cristo, pietà.",
        "Santa Maria, Regina degli Angeli, prega per noi.",
        "San Michele, pieno della sapienza di Dio, prega per noi.",
        "San Michele, perfetto adoratore del Verbo incarnato, prega per noi."
      ]
    },
    panic: "Gesù, Maria e Giuseppe, proteggetemi. San Michele, difendimi ora."
  },
  de: {
    prayer: {
      title: "Gebet zum heiligen Michael",
      lines: [
        "Heiliger Erzengel Michael, verteidige uns im Kampfe.",
        "Gegen die Bosheit und die Nachstellungen des Teufels sei unser Schutz.",
        "Gott gebiete ihm, so bitten wir flehentlich;",
        "du aber, Fürst der himmlischen Heerscharen,",
        "stoße den Satan und die anderen bösen Geister in die Hölle,",
        "die zum Verderben der Seelen in der Welt umhergehen. Amen."
      ]
    },
    chaplet: {
      title: "Rosenkranz des heiligen Michael",
      lines: [
        "O Gott, komm mir zu Hilfe.",
        "Herr, eile, mir zu helfen.",
        "Gruß an die neun Chöre der Engel.",
        "Für jeden Chor ein Vaterunser und drei Ave Maria.",
        "Schließe mit Gebeten zu Michael, Gabriel, Raphael und den Schutzengeln."
      ]
    },
    litany: {
      title: "Litanei des heiligen Michael",
      lines: [
        "Herr, erbarme dich.",
        "Christus, erbarme dich.",
        "Heilige Maria, Königin der Engel, bitte für uns.",
        "Heiliger Michael, erfüllt von Gottes Weisheit, bitte für uns.",
        "Heiliger Michael, vollkommener Anbeter des fleischgewordenen Wortes, bitte für uns."
      ]
    },
    panic: "Jesus, Maria und Josef, beschützt mich. Heiliger Michael, verteidige mich jetzt."
  },
  ja: {
    prayer: {
      title: "聖ミカエルへの祈り",
      lines: [
        "聖ミカエル、戦いにおいて私たちを守ってください。",
        "悪魔の邪悪とわなに対する私たちの守りとなってください。",
        "神が彼を戒めてくださるよう、へりくだって祈ります。",
        "天の軍勢の長よ、",
        "神の力によってサタンを地獄に追いやってください。",
        "そして霊魂を滅ぼそうと世をさまよう悪霊をも。アーメン。"
      ]
    },
    chaplet: {
      title: "聖ミカエルのチャプレット",
      lines: [
        ...
        "主よ、速やかに私を助けてください。",
        "九つの天使の位階への挨拶。",
        "各位階ごとに主の祈り1回とアヴェ・マリア3回を唱えます。",
        "最後に聖ミカエル、聖ガブリエル、聖ラファエル、守護天使への祈りで結びます。"
      ]
    },
    litany: {
      title: "聖ミカエルの連願",
      lines: [
        "主よ、あわれみたまえ。",
        "キリストよ、あわれみたまえ。",
        "天使の元后なる聖マリア、私たちのために祈ってください。",
        "神の知恵に満ちた聖ミカエル、私たちのために祈ってください。",
        "受肉したみことばを完全に礼拝する聖ミカエル、私たちのために祈ってください。"
      ]
    },
    panic: "イエス、マリア、ヨセフ、私を守ってください。聖ミカエル、今すぐ私を守ってください。"
  }
};
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("service-worker.js").catch(() => {
      announce("Offline mode unavailable");
    });
  });
}
